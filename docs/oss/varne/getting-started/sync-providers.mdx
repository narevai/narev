...
order: 3
description: "Trigger manual syncs, monitor scheduled imports, and troubleshoot failures when ingesting cloud and AI provider billing data into Varne."
---

After connecting your billing data providers, you need to manually sync their data into Varne for analysis. This guide explains how to trigger and manage your billing data synchronization.

## How data sync works

Varne uses **manual synchronization** - you trigger data imports when needed rather than on a schedule. This gives you full control over when and what data to import.

### Sync process

1. **Connect Provider** - Link your cloud account ([see provider guides](/oss/varne/connect-providers))
...
1. In the Varne sidebar, under **Data Connections**, click **Sync**
...
Your billing data is now ready for analysis in Varne
