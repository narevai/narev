...
outline: deep
description: "Configure Azure Cost Management exports to Blob Storage, grant the service principal access, and sync Azure usage into Varne."
---
...
<Frame>
<img src="/images/oss/varne/screenshots/azure-storage-accounts.png" alt="Azure Storage Accounts" />
</Frame>
...
<Frame>
<img src="/images/oss/varne/screenshots/azure-export-template.png" alt="Azure Export Template Selection" />
</Frame>

5. **Select Export Template**: Choose **Cost and usage (FOCUS)** template
   - This exports data in FOCUS 1.0 format, which Varne maps to FOCUS 1.2
...
<Frame>
<img src="/images/oss/varne/screenshots/azure-export-destination.png" alt="Azure Export Destination" />
</Frame>
...
6. Store it securely because Varne uses it for authentication
...
## Adding Azure Provider in Varne
...
<Frame>
<img src="/images/oss/varne/screenshots/varne-azure-provider-dialog.png" alt="Varne Azure Provider Dialog" />
</Frame>
...
3. Varne tests the connection to your Azure Storage
...
- Ensure the export path in Varne matches the directory configured in your export
