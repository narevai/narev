...
outline: deep
description: "Connect AWS Cost and Usage Reports from S3 to Varne using IAM credentials, then sync them into the FOCUS specification."
---
...
<Frame>
<img src="/images/oss/varne/screenshots/aws-create-export.png" alt="AWS Create Export Interface" />
</Frame>

### 2. Configure export details

1. **Choose Export Type:**
   - Select **Standard data export** (recommended for Varne integration)
   - Alternatively, you can choose **Legacy CUR export** for compatibility with older systems

2. **Export Name:**
   - Enter a descriptive name (for example, `MyCostExport`, `Varne-Export`)
...
Select **FOCUS 1.0 with AWS columns** - this is the format Varne optimizes for:
...
- **FOCUS 1.0 with AWS columns** ✅ (Required)
  ...
  - Fully supported by Varne's cost optimization engine
...
<Frame>
<img src="/images/oss/varne/screenshots/aws-data-delivery-options.png" alt="AWS Data Delivery Options" />
</Frame>
...
<Frame>
<img src="/images/oss/varne/screenshots/aws-create-bucket.png" alt="AWS Create Bucket" />
</Frame>
...
Varne requires AWS credentials to access your cost data. Here's what you need:
...
1. Varne logs in with your Access Keys
...
6. Note the **Role ARN** for Varne configuration
...
## Adding AWS Provider in Varne

### Step 1: Navigate to Connect

1. In the Varne sidebar, under **Data Connections**, click **Connect**
...
<Frame>
<img src="/images/oss/varne/screenshots/varne-aws-provider-dialog.png" alt="Varne AWS Provider Dialog" />
</Frame>
...
3. Varne tests the connection to your AWS S3 bucket
4. If successful, Varne adds the provider and marks it as "Connected"
...
Data collection runs automatically based on your configured schedule and will appear in the Varne dashboard after the first successful sync. AWS export data is typically updated once per day with your selected refresh cadence.
