...
outline: deep
description: "Enable GCP billing exports to BigQuery, build a FOCUS-aligned view, and sync Google Cloud usage and cost data into Varne."
---
...
<Frame>
<img src="/images/oss/varne/screenshots/gcp-billing-export.png" alt="GCP BigQuery Billing Export" />
</Frame>
...
2. Follow one of these guides to create the FOCUS view:
   ...
   - **FinOps Foundation guide**: [Creating FOCUS Views in BigQuery](/images/oss/varne/guides/gcp-focus-guide-v1.pdf) (comprehensive step-by-step)
...
After setup, note these details for Varne configuration:
...
<Frame>
<img src="/images/oss/varne/screenshots/gcp-create-service-account.png" alt="GCP Service Accounts" />
</Frame>

2. Click **Create Service Account**
3. Provide details:
   - Username: `narevai-billing-reader`
   - Description: `Service account for Varne billing analysis`
...
<Frame>
<img src="/images/oss/varne/screenshots/varne-gcp-provider-dialog.png" alt="Varne GCP Provider Dialog" />
</Frame>
...
3. Varne tests the connection to your BigQuery dataset
...
4. Use this exact view name in your Varne provider configuration

<Warning>
  **FOCUS View Required**: Varne requires a FOCUS-compliant BigQuery view for GCP billing data. You must create this
...
in the Varne dashboard after the first successful sync.
