...
title: 'OpenAI'
outline: deep
description: "Use an OpenAI administrator API key to pull usage and billing data into Varne and unify it with cloud spend in FOCUS format."
---
...
3. In the key creation form:
   - **Name**: Provide a descriptive name (for example, "Varne Billing Access")
...
## Adding OpenAI Provider in Varne
...
<Frame>
<img src="/images/oss/varne/screenshots/varne-openai-provider-dialog.png" alt="Varne OpenAI Provider Dialog" />
</Frame>
...
3. Varne tests the connection to OpenAI API
