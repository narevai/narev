...
description: "Reference for the FOCUS 1.2 fields, categories, and dimensions that Varne uses to normalize cloud and AI provider billing data."
---

The **FinOps Open Cost and Usage Specification (FOCUS)** is an open specification that defines a consistent format for cloud cost and usage datasets. `narevai/varne` translates billing data to FOCUS 1.2, allowing standardized billing data across all cloud providers.
